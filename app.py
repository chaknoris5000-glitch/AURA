...
# ============================================================
# РАСПОЗНАВАНИЕ ИЗОБРАЖЕНИЙ (ДЕШЁВАЯ ВЕРСИЯ)
# ============================================================
...
# ============================================================
# УПАКОВКА ОТВЕТА (ОРИГИНАЛ ИЗ ПЕРВОГО КОДА)
# ============================================================
...
7. **ССЫЛКА:** добавь ссылку на источник.
...
async def webhook(request: Request):
    try:
        ...
        # ============================================================
        # ПОИСК В ИНТЕРНЕТЕ (ЯНДЕКС-АГЕНТЫ)
        # ============================================================
